...
//Code Here
let totalPopulation = populations.reduce(function(accum, num){
  return accum + num
})
...
let bobsPurchases = purchases.filter(function(transaction){
  return transaction.owner === "Bob"
})

let bobArr = bobsPurchases.map(function(trans){
  return trans.price
})

let bobsTotal = bobArr.reduce(function(accum, current){
